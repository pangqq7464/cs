...
<html>
	<head>
		...
		function shopUpd(shop_id) {
			var d = top.dialog({
				url:'shop/shopUpd?shop_id='+shop_id,
			    title: '修改员工信息',
			    width:600,
			    height:400,
			    onclose:function (){
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <div class="row m-b-sm m-t-sm">
                            <div class="col-md-2">
                                <button type="button" onclick="shopAdd()" class="btn btn-primary btn-sm"><i class="fa fa-shop-plus"></i> 新建</button>
                       ...
                       <form action="shop/shopDetailList" method="post">
                         ...
                         <form action="shop/selShopByregister" method="post">
                                    ...
                                    <c:forEach items="${shopList }" var="shop">
	                                    <tr>
	                                        ...
	                                        <td width="100px" align="center">
	                                            ...
	                                            <a href="javascript:shopUpd(${shop.shop_id } );" class="btn btn-success btn-sm" ><i class="fa fa-pencil"></i> 编辑</a>
