...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div style="color: Deeppink" class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    ...
                                    <span class="text-muted text-xs block">商户<b class="caret"></b>
                    ...
                    <li>
                        <!-- 一级菜单 -->
                        <a class="J_menuItem" href="shop/selShopByregister">
                     ...
                     <li>
                        <!-- 一级菜单 -->
                        <a class="J_menuItem" href="goods/goodsList?user_account=${user.user_account }">
                            <i class="fa fa-home"></i>
        ...
        $(function(){
            $("#logout").on("click",function () {
                layer.confirm('您确定要退出我们这个系统吗？', {
                    ...
                    window.top.location.href="login-hp.html";
                }, function(){
