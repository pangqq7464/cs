...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img width = "150px" alt="image" class="img-circle" src="upload/${user.user_image}"  /></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a href="back/loginDoH">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <!-- 折叠导航栏目时候显示的文字 -->
                    ...
                    <li>
                        <a class="J_menuItem" href="http://www.baidu.com" ><i class="fa fa-home"></i> <span class="nav-label">主页</span></a>
                    </li>
                    <li>
                        <!-- 一级菜单 -->
                        <a href="back/userList" class="J_menuItem">
                            <i class="fa fa-home"></i>
                            <span class="nav-label" >人员管理</span>
                            <span class="fa arrow"></span>
                        </a>
                   
                        <a class="J_menuItem" href="shop/shopDetailList">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">商户管理</span>
                            <span class="fa arrow"></span>
                        </a>
                        <a class="J_menuItem" href="back/specialtyList">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">特产信息管理</span>
                            <span class="fa arrow"></span>
                        </a>
                       
                        <a class="J_menuItem" href="back/loginDetail">
                            <i class="fa fa fa-bar-chart-o"></i>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="javascript:;" class="roll-nav roll-right J_tabExit" id="logout"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="http://www.baidu.com?v=4.0" frameborder="0" data-id="http://www.baidu.com" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right"><a href="http://www.zi-han.net/" target="_blank"></a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <!-- 自定义js -->
    <script src="back/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="back/js/contabs.js"></script>
    ...
    <script type="text/javascript">
        $(function(){
            $("#logout").on("click",function () {
                layer.confirm('您确定要退出我们这个系统吗？', {
                    anim: 4,
                    btn: ['狠心一下','继续逛逛'] //按钮
                }, function(){
                    window.top.location.href="back/loginDoH";
                }, function(){
