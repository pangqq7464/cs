			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" width="227" height="70">
						<div class="logo">
							<img src="before/img/logo/title.jpg" width="300" height="50"alt="" />
						</div>
					</div>
									...
									<div >
										<div id="specialty-img">
											<a href="shop/selShopDetails?shop_id=${goods.shop.shop_id}">
												<img class="primary-img" src="upload/${goods.goods_img }" style="width: 400px;height: 200px"alt="" />
											
											</a>
										</div>
										<div class="product-info" id="specialty-message">
											<div class="specialty-title">
												<a href="shop/selShopDetails?shop_id=${goods.shop.shop_id}">${goods.goods_name }</a>	
											</div>
											<br>
