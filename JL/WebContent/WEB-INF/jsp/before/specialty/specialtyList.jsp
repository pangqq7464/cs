									...
									<div >
										<div id="specialty-img">
											<a href="before/singleSpecialty?specialty_id=${specialty.specialty_id}">
												<img class="primary-img" src="upload/${specialty.specialty_img }" style="width: 400px;height: 200px"alt="" />
											
											</a>
										</div>
										<div class="product-info" id="specialty-message">
											<div class="specialty-title">
												<a href="before/singleSpecialty?specialty_id=${specialty.specialty_id}">${specialty.specialty_name }</a>	
											</div>
											<br>
