...
<div class="heading-banner">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					<li><a href="shop/selShopByGoods?goods_name=${specialty.specialty_name }">售卖店铺</a></li>
...
<div class="container" >
    <div >
    	<p style="text-align: center;font-family: 微软雅黑;font-weight: border;font-size: 30px;">${specialty.specialty_name }</p>
   	</div>
	   	...
	   	<div style="width: 1300px;height: 130px">
	   		...
	   		<div style="float: left;">
				...
				<div style="border:1px solid #CACACA;padding:5px;margin-bottom: 0;margin-left: 20px;width:1000px;height: 70px" >${common.common_message}</div>
			 		<div class="action" style="color:red;margin-left: 20px;margin-top: 5px;color:#C1C1C1">更新于@${common.common_time}&nbsp&nbsp评论:
